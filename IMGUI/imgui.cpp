...
ImGuiStyle::ImGuiStyle()
{
    ...
    TouchExtraPadding       = ImVec2(4,4);      // Expand reactive bounding box for touch-based system where touch position is not accurate enough. Unfortunately we don't sort widgets so priority on overlap will always be given to the first widget. So don't grow this too much!
    ...
    Colors[ImGuiCol_TextDisabled]           = ImVec4(0.90f, 0.90f, 0.90f, 0.60f);
    ...
    Colors[ImGuiCol_TitleBg]                = ImVec4(0.25f, 0.25f, 0.27f, 1.00f);
    ...
    Colors[ImGuiCol_MenuBarBg]              = ImVec4(0.40f, 0.40f, 0.55f, 1.00f);
