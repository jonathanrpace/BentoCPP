...
#define DEFINE_NODE_4(NODE_TYPE, MEMBER_TYPE_0, MEMBER_NAME_0, MEMBER_TYPE_1, MEMBER_NAME_1, MEMBER_TYPE_2, MEMBER_NAME_2, MEMBER_TYPE_3, MEMBER_NAME_3)\
struct NODE_TYPE : bento::INode \
{\
	MEMBER_TYPE_0* MEMBER_NAME_0; \
	MEMBER_TYPE_1* MEMBER_NAME_1; \
	MEMBER_TYPE_2* MEMBER_NAME_2; \
	MEMBER_TYPE_3* MEMBER_NAME_3; \
	DEFINE_NODE_COMMON(NODE_TYPE, MEMBER(NODE_TYPE, MEMBER_TYPE_0, MEMBER_NAME_0) MEMBER(NODE_TYPE, MEMBER_TYPE_1, MEMBER_NAME_1) MEMBER(NODE_TYPE, MEMBER_TYPE_2, MEMBER_NAME_2) MEMBER(NODE_TYPE, MEMBER_TYPE_3, MEMBER_NAME_3), 4) \

#define DEFINE_NODE_5(NODE_TYPE, MEMBER_TYPE_0, MEMBER_NAME_0, MEMBER_TYPE_1, MEMBER_NAME_1, MEMBER_TYPE_2, MEMBER_NAME_2, MEMBER_TYPE_3, MEMBER_NAME_3, MEMBER_TYPE_4, MEMBER_NAME_4)\
struct NODE_TYPE : bento::INode \
{\
	MEMBER_TYPE_0* MEMBER_NAME_0; \
	MEMBER_TYPE_1* MEMBER_NAME_1; \
	MEMBER_TYPE_2* MEMBER_NAME_2; \
	MEMBER_TYPE_3* MEMBER_NAME_3; \
	MEMBER_TYPE_4* MEMBER_NAME_4; \
	DEFINE_NODE_COMMON(NODE_TYPE, MEMBER(NODE_TYPE, MEMBER_TYPE_0, MEMBER_NAME_0) MEMBER(NODE_TYPE, MEMBER_TYPE_1, MEMBER_NAME_1) MEMBER(NODE_TYPE, MEMBER_TYPE_2, MEMBER_NAME_2) MEMBER(NODE_TYPE, MEMBER_TYPE_3, MEMBER_NAME_3) MEMBER(NODE_TYPE, MEMBER_TYPE_4, MEMBER_NAME_4), 5) \

/* Example output of:
DEFINE_NODE_3( Node, int, var0, bool, var1, float, var2 )

struct Node : bento::INode
{
	int* var0;
	bool* var1;
	float* var2;
