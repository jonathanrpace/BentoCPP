...
namespace bento
{
	TerrainGeometry::TerrainGeometry(std::string _name)
		...
		, m_heightDataA(m_numVerticesPerDimension, GL_RGBA16F, GL_LINEAR, GL_NEAREST, GL_REPEAT, GL_REPEAT)
		, m_heightDataB(m_numVerticesPerDimension, GL_RGBA16F, GL_LINEAR, GL_NEAREST, GL_REPEAT, GL_REPEAT)
		...
		, m_normalData(m_numVerticesPerDimension, GL_RGBA16F, GL_NEAREST, GL_NEAREST, GL_REPEAT, GL_REPEAT)
