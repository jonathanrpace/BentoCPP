...
{\
	...
	DEFINE_NODE_COMMON(NODE_TYPE, MEMBER(NODE_TYPE, MEMBER_NAME_0), 1) \
...
{\
	...
	DEFINE_NODE_COMMON(NODE_TYPE, MEMBER(NODE_TYPE, MEMBER_NAME_0) MEMBER(NODE_TYPE, MEMBER_NAME_1), 2) \
...
{\
	...
	DEFINE_NODE_COMMON(NODE_TYPE, MEMBER(NODE_TYPE, MEMBER_NAME_0) MEMBER(NODE_TYPE, MEMBER_NAME_1) MEMBER(NODE_TYPE, MEMBER_NAME_2), 3) \
